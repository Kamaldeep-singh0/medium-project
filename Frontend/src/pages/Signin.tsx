  ...
  return (
    ...
    <div className='w-3/6 h-screen   flex flex-col items-center justify-center p-5'>
      <div className='bg-white w-2/3 h-5/6 flex flex-col items-center p-5' >
          ...
          <h3 className='text-lg text-gray-600 my-2'>New to Medium? <Link to="/signup" className='underline'>SignUp</Link></h3>
          ...
          <button className='my-5 w-full h-12 bg-black rounded-md text-white text-xl font-semibold'>Sign in</button>
